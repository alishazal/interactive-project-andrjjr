...
void setup() {
  ...
  // Additional addresses for the separate learning models. 
  dest_2 = new NetAddress("127.0.0.1", 6451); // send to wekiHelper, listen on 6451
  dest_3 = new NetAddress("127.0.0.1", 6450); 

  leap = new LeapMotion(this);
  sendInputNames(dest);
  //sendInputNames(dest_2);
  //sendInputNames(dest_3);
...
//====== OSC SEND ======
// added an argument to sendOsc, a NetAddress class that gives the port
void sendOsc(NetAddress destination) {
...
// added an argument to sendInputNames, a NetAddress class that gives the port
void sendInputNames(NetAddress destination) {
